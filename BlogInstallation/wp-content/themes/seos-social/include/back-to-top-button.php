...
add_action( 'customize_register', 'seos_social_back_to_top_customize_register' );

function seos_social_back_to_top_customize_register( $wp_customize ) {
...
***********************************************************************************/
		...
		$wp_customize->add_section( 'back_to_top' , array(
			'title'       => __( 'Back To Top Button Options', 'seos-social' ),
			'priority'   => 98,
		) );
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'activate_back_to_top', array(
			'label'    => __( 'Activate Back To Top Button', 'seos-social' ),
			'section'  => 'back_to_top',
		...
		'label' => __('Button Color', 'seos-social'),        
		'section' => 'back_to_top',
		...
		'label' => __('Button Hover Color', 'seos-social'),        
		'section' => 'back_to_top',
		...
		'label' => __('Button Background Color', 'seos-social'),        
		'section' => 'back_to_top',
		...
		'label' => __('Button Background Hover Color', 'seos-social'),        
		'section' => 'back_to_top',
...
add_action( 'wp_enqueue_scripts', 'seos_social_back_top_method' );	

function seos_social_back_top_method() {
...
function seos_social_to_top() {
    echo '<a id="totop" href="#"><span class="dashicons dashicons-arrow-up-alt2"></span></a>';
    }

    add_action( 'wp_head', 'seos_social_back_to_top_style' );
    function seos_social_back_to_top_style() {
    echo '<style>
    #totop {
		position: fixed;
		right: 40px;
